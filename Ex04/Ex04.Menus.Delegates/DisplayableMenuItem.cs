...
{
    public class DisplayableMenuItem : MenuItem
    {
        ...
        public void Show()
        {
            ...
            while (!userReturn)
            {
                ...
                int i = 1;
                foreach (MenuItem subMenuItem in this.SubMenus)
                {
                    displayMenuBuilder.Append(i++ + ": ");
                    displayMenuBuilder.AppendLine(subMenuItem.MenuTitle);
                }
        ...
        private bool performUserOperation(int i_UserChoice)
        {
            ...
            else
            {
                ...
                {
                    runnableMenu.doWhenMenuSelected();
                }
                else
                {
